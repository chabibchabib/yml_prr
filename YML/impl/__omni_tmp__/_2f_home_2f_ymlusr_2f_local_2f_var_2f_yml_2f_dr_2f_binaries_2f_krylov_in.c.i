 ...
 * Language         : C
 * Compiled Time    : 2020-08-12 15:55:13
...
void * gmv4;
void * gmv5;
# 63 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
double sum = 0;
{
...
# 72 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
if((_XMP_M_LTOG_TEMPLATE_BLOCK(j, 0, 6, 1, _XMP_NODES_RANK__XMP_default_nodes_0)) == ((_XMP_M_LTOG_TEMPLATE_BLOCK(i, 0, 6, 2, _XMP_NODES_RANK__XMP_default_nodes_1)) - (1))) {
# 72 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
(*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_A, i, j, _XMP_GTOL_acc_A_0))) = (-(2));
}
...
# 80 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 84 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 87 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 89 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (sqrt(sum));
{
int _XMP_loop_init_i;
int _XMP_loop_cond_i;
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 93 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 98 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 107 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (0);
{
int _XMP_loop_init_j;
int _XMP_loop_cond_j;
...
for(j = _XMP_loop_init_j; j < _XMP_loop_cond_j; j += _XMP_loop_step_j) {
{
# 110 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum += ((*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_A, i, j, _XMP_GTOL_acc_A_0))) * (*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_yy_0, j))));
}
}
}
# 112 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
{
# 117 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
int k;
# 117 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
for(k = (1); k < m; k++) {
{
void * gmv2;
void * gmv3;
# 119 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (0);
{
int _XMP_loop_init_i;
int _XMP_loop_cond_i;
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 123 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 125 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
(*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_c, _XMP_M_CALC_INDEX_BLOCK(((2) * k) - (1), _XMP_GTOL_temp0_c_0)))) = sum;
# 127 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (0);
{
int _XMP_loop_init_i;
int _XMP_loop_cond_i;
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 131 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 133 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 138 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 146 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 150 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (0);
{
int _XMP_loop_init_j;
int _XMP_loop_cond_j;
...
for(j = _XMP_loop_init_j; j < _XMP_loop_cond_j; j += _XMP_loop_step_j) {
{
# 153 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum += ((*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_A, i, j, _XMP_GTOL_acc_A_0))) * (*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_yy_0, j))));
}
}
}
# 155 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
(*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_y_1, i))) = sum;
}
}
if(_XMP_init_reduce_comm_TEMPLATE(_XMP_DESC_t, (int)(1), (int)(0))) {
...
# 162 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum = (0);
{
int _XMP_loop_init_i;
int _XMP_loop_cond_i;
...
for(i = _XMP_loop_init_i; i < _XMP_loop_cond_i; i += _XMP_loop_step_i) {
{
# 165 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
sum += ((*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_y_0, i))) * (*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_y_1, i))));
}
}
if(_XMP_init_reduce_comm_TEMPLATE(_XMP_DESC_t, (int)(1), (int)(0))) {
...
# 167 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
{
# 176 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
int i;
# 176 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
for(i = (0); i < ((2) * m); i++) {
{
...
# 180 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
printf("\n");
_XMP_pop_nodes();
}
...
MPI_Barrier((struct ompi_communicator_t * )((void * )(&(ompi_mpi_comm_world))));
# 187 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 193 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 197 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 201 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
...
# 205 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
type_export((void * )(_XMP_ADDR_Vm), *(argv + (4)), Matrix_MPI_Type, Matrix_export, "6,6;1,2;1,1;[i][j]:(j,i)");
}
}
# 209 "/home/ymlusr/local/var/yml/dr/binaries/krylov.c"
return 0;
}
extern void xmpc_traverse_init_file__2f_home_2f_ymlusr_2f_local_2f_var_2f_yml_2f_dr_2f_binaries_2f_krylov_pp()
{
