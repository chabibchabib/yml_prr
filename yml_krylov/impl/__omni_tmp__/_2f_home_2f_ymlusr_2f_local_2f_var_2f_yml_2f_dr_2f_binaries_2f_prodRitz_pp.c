...
int main_prodRitz(int argc, char **argv)
{

  {
    ...
    type_import((void *)_XMP_M_GET_ADDR_0(_XMP_ADDR_Vm),argv[1],Matrix_MPI_Type,Matrix_import,"6,3;1,2;1,1;[i][*]:(*,i)");
    extern XMP_Matrix *_XMP_ADDR_res;
    type_import((void *)_XMP_M_GET_ADDR_0(_XMP_ADDR_res),argv[2],Matrix_MPI_Type,Matrix_import,"4,6;1,2;1,1;[*][j]:(j,*)");
  }
