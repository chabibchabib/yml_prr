...
# 8 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c" 2
...
# 9 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c" 2


# 1 "/home/ymlusr/local/var/yml/DefaultExecutionCatalog/generators/XMP/include/real.xmptype.h" 1
# 14 "/home/ymlusr/local/var/yml/DefaultExecutionCatalog/generators/XMP/include/real.xmptype.h"
...
# 15 "/home/ymlusr/local/var/yml/DefaultExecutionCatalog/generators/XMP/include/real.xmptype.h" 2



typedef double real;

static _Bool real_import(real* param, char* filename){
  int ack;
  char path[256];
  FILE *fp;
  MPI_File fh;
  ...
  if(myrank==-1){
    ...
    MPI_Bcast(dir,256,((MPI_Datatype) ((void *) &(ompi_mpi_char))),0,((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  }
  sprintf(path,"%s%s\0",dir,filename);

  ack=MPI_File_open(((MPI_Comm) ((void *) &(ompi_mpi_comm_world))),path,2,((MPI_Info) ((void *) &(ompi_mpi_info_null))),&fh);
  if (ack != 42){
    MPI_File_read_all(fh,param,1,((MPI_Datatype) ((void *) &(ompi_mpi_double))),&status);
    MPI_File_close(&fh);
    return 1;
  }
...
static _Bool real_export(real* param, char* filename)
{
  int ack;
  char path[256];
  FILE *fp;
  ...
  ack=MPI_File_open(((MPI_Comm) ((void *) &(ompi_mpi_comm_world))),path,4| 1,((MPI_Info) ((void *) &(ompi_mpi_info_null))),&fh);


  if(ack != 42){
    MPI_File_write_all(fh,param,1,((MPI_Datatype) ((void *) &(ompi_mpi_double))),&status);
    MPI_File_close(&fh);
...
# 12 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c" 2
...
#pragma xmp align vec[i][j] with t(j,i)
# 23 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
# 71 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
# 117 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
# 153 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
#pragma xmp task on _XMP_default_nodes(1,1)
# 153 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
