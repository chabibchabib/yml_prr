 ...
 * Language         : C
 * Compiled Time    : 2020-08-13 11:40:26
...
# 29 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
/* ignored Xcode.XMP_PRAGMA */
...
# 39 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
/* ignored Xcode.XMP_PRAGMA */
...
{
# 60 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int n = 6;
# 60 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int m = 3;
...
{
{
# 65 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int j;
# 65 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(j = _XMP_loop_init_j; j < _XMP_loop_cond_j; j += _XMP_loop_step_j) {
{
# 66 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
# 69 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
if((_XMP_M_LTOG_TEMPLATE_BLOCK(j, 0, 6, 1, _XMP_NODES_RANK__XMP_default_nodes_0)) == ((_XMP_M_LTOG_TEMPLATE_BLOCK(i, 0, 6, 2, _XMP_NODES_RANK__XMP_default_nodes_1)) - (1))) {
# 69 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
(*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_A, i, j, _XMP_GTOL_acc_A_0))) = (-(2));
}
...
for(j = _XMP_loop_init_j; j < _XMP_loop_cond_j; j += _XMP_loop_step_j) {
{
# 76 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
(*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_Id, i, j, _XMP_GTOL_acc_Id_0))) = (0);
# 77 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
if((_XMP_M_LTOG_TEMPLATE_BLOCK(i, 0, 6, 2, _XMP_NODES_RANK__XMP_default_nodes_1)) == (_XMP_M_LTOG_TEMPLATE_BLOCK(j, 0, 6, 1, _XMP_NODES_RANK__XMP_default_nodes_0))) {
# 77 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
int _XMP_loop_cond_j;
int _XMP_loop_step_j;
# 83 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int j;
...
{
{
# 84 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
# 84 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(i = (0); i <= m; i++) {
{
# 85 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
int _XMP_loop_cond_j;
int _XMP_loop_step_j;
# 89 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_i), &(_XMP_loop_cond_i), &(_XMP_loop_step_i), _XMP_DESC_t, 1);
_XMP_sched_loop_template_BLOCK(0, m, 1, &(_XMP_loop_init_j), &(_XMP_loop_cond_j), &(_XMP_loop_step_j), _XMP_DESC_t, 0);
# 89 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
{
{
# 90 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int j;
# 90 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(j = _XMP_loop_init_j; j < _XMP_loop_cond_j; j += _XMP_loop_step_j) {
{
# 91 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
(*(_XMP_M_GET_ADDR_E_2(_XMP_ADDR_vec, i, j, _XMP_GTOL_acc_vec_0))) = ((_XMP_M_LTOG_TEMPLATE_BLOCK(i, 0, 6, 2, _XMP_NODES_RANK__XMP_default_nodes_1)) + (_XMP_M_LTOG_TEMPLATE_BLOCK(j, 0, 6, 1, _XMP_NODES_RANK__XMP_default_nodes_0)));
}
}
}
}
...
{
# 95 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int k;
# 95 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(k = (0); k < m; k++) {
{
...
int _XMP_loop_cond_j;
int _XMP_loop_step_j;
# 100 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_i), &(_XMP_loop_cond_i), &(_XMP_loop_step_i), _XMP_DESC_t, 1);
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_j), &(_XMP_loop_cond_j), &(_XMP_loop_step_j), _XMP_DESC_t, 0);
# 100 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
int _XMP_loop_cond_j;
int _XMP_loop_step_j;
# 105 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_i), &(_XMP_loop_cond_i), &(_XMP_loop_step_i), _XMP_DESC_t, 1);
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_j), &(_XMP_loop_cond_j), &(_XMP_loop_step_j), _XMP_DESC_t, 0);
...
# 110 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
(*(_XMP_M_GET_ADDR_E_1(_XMP_ADDR_tmp1, i))) = sum;
# 111 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
sum = (0.0);
}
}
...
int _XMP_loop_cond_i;
int _XMP_loop_step_i;
# 115 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_i), &(_XMP_loop_cond_i), &(_XMP_loop_step_i), _XMP_DESC_t, 1);
if((_XMP_get_execution_nodes_rank()) != (0)) sum = (0);
# 115 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
# 121 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
sum = (0.0);
}
}
}
...
{
# 126 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
# 126 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(i = (0); i < m; i++) {
{
...
# 127 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
printf("\n");
_XMP_pop_nodes();
}
...
int _XMP_loop_cond_j;
int _XMP_loop_step_j;
# 132 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_i), &(_XMP_loop_cond_i), &(_XMP_loop_step_i), _XMP_DESC_t, 1);
_XMP_sched_loop_template_BLOCK(0, n, 1, &(_XMP_loop_init_j), &(_XMP_loop_cond_j), &(_XMP_loop_step_j), _XMP_DESC_t, 0);
...
{
# 143 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
int i;
# 143 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
for(i = (0); i < m; i++) {
{
...
# 144 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
printf("\n norme: %f\n", norme_A);
# 145 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
printf("\n");
_XMP_pop_nodes();
}
...
{
{
# 157 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
...
{
# 161 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
extern double * _XMP_ADDR_vec;
# 162 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
type_export((void * )(_XMP_ADDR_vec), *(argv + (2)), Matrix_MPI_Type, Matrix_export, "6,6;1,2;1,1;[i][j]:(j,i)");
}
{
# 165 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
extern double * _XMP_ADDR_res;
# 166 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
type_export((void * )(_XMP_ADDR_res), *(argv + (3)), Matrix_MPI_Type, Matrix_export, "4,6;1,2;1,1;[*][j]:(j,*)");
}
{
# 169 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
extern double * _XMP_ADDR_erreur;
# 170 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
type_export((void * )(_XMP_ADDR_erreur), *(argv + (4)), vector_MPI_Type, vector_export, "6;1,2;1,1;[j]:(j,*)");
}
}
# 174 "/home/ymlusr/local/var/yml/dr/binaries/erreur.c"
return 0;
}
extern void xmpc_traverse_init_file__2f_home_2f_ymlusr_2f_local_2f_var_2f_yml_2f_dr_2f_binaries_2f_erreur_pp()
{
